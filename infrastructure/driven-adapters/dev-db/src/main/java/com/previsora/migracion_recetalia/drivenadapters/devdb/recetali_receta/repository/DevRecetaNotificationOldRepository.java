...
@Repository
public interface DevRecetaNotificationOldRepository extends ReactiveCrudRepository<DevRecetaNotificationOldEntity, String> {

    @Query("SELECT COUNT(*) FROM recetali_receta.notification_old WHERE id = :id")
