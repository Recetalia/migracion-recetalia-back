...
@Repository
public interface DevFranchiseRepository extends ReactiveCrudRepository<DevFranchiseEntity, String> {

    @Query("SELECT COUNT(*) FROM recetali_receta.franchise WHERE id = :id")
