...
@Repository
public interface DevNotificationRepository extends ReactiveCrudRepository<DevNotificationEntity, String> {

    @Query("SELECT COUNT(*) FROM recetali_receta.notification WHERE id = :id")
