...
/**
 * R2DBC entity mapped to prod {@code recetali_receta.pharmacy}.
 * <p>
 * READ-ONLY — this entity should never be persisted back to prod.
 */
@Table("`recetali_receta`.`pharmacy`")
public class ProdRecetaPharmacyEntity {
