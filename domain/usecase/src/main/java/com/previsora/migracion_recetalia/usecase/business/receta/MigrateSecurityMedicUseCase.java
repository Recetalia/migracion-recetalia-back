...
/**
 * Migrates medics from prod.recetali_receta.medic into dev.securitydb.users.
 * <p>
 ...
 * <p>
 * The SourceReader reads from prod.recetali_receta.medic and derives SecurityUser
 * domain objects using {@link SecurityUser#fromRecetaMedic}.
 * The TargetWriter writes to dev.securitydb.users.
 * <p>
 * Business key for duplicate detection: email (unique constraint).
 */
public class MigrateSecurityMedicUseCase extends AbstractMigrationUseCase<SecurityUser> {

    public static final String MIGRATION_NAME = "security-medics";

    private final SourceReader<SecurityUser> sourceReader;
    private final TargetWriter<SecurityUser> targetWriter;

    public MigrateSecurityMedicUseCase(SourceReader<SecurityUser> sourceReader,
